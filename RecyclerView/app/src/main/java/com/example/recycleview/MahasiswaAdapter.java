...
public class MahasiswaAdapter extends RecyclerView.Adapter<MahasiswaAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txNama = (TextView) itemView.findViewById(R.id.tx_nama_mahasiswa);
            txNpm = (TextView) itemView.findViewById(R.id.tx_npm_mahasiswa);
            txNohp = (TextView) itemView.findViewById(R.id.tx_nohp_mahasiswa);
        }
    }
}
